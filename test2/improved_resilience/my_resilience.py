...
print("improved_resilience1:{}\t".format(resilience1 * tm.time_amend(t_ss1 - t_ss1_reverse,absolute_time)))
#
#
#
# 案例2
...
print("improved_resilience2:{}\t".format(resilience2 * tm.time_amend(t_ss2 - t_ss2_reverse,absolute_time)))
...
print("improved_resilience3:{}\t".format(resilience3 * tm.time_amend(t_ss3 - t_ss3_reverse,absolute_time)))
...
# 毁伤前稳态时间
t_ss4_reverse,min_var4_reverse = tm.calculate(t_case2_reverse, y_t4_reverse)
tau4 = t_ss4/100
...
print("improved_resilience4:{}\t".format(resilience4 * tm.time_amend(t_ss4 - t_ss4_reverse,absolute_time)))
...
# 毁伤前稳态时间
t_ss5_reverse,min_var5_reverse = tm.calculate(t_case2_reverse, y_t5_reverse)
tau5 = t_ss5/100
...
print("improved_resilience5:{}\t".format(resilience5 * tm.time_amend(t_ss5 - t_ss5_reverse,absolute_time)))
...
print("improved_resilience6:{}\t".format(resilience6 * tm.time_amend(t_ss6 - t_ss6_reverse,absolute_time)))
print("###############################################################################################################")
...
print("improved_resilience7:{}\t".format(resilience7 * tm.time_amend(t_ss7 - t_ss7_reverse,absolute_time)))
...
print("improved_resilience8:{}\t".format(resilience8 * tm.time_amend(t_ss8 - t_ss8_reverse,absolute_time)))
...
print("improved_resilience9:{}\t".format(resilience9 * tm.time_amend(t_ss9 - t_ss9_reverse,absolute_time)))
...
print("improved_resilience10:{}\t".format(resilience10 * tm.time_amend(t_ss10 - t_ss10_reverse,absolute_time)))
...
print("improved_resilience11:{}\t".format(resilience11 * tm.time_amend(t_ss11 - t_ss11_reverse,absolute_time)))
...
print("improved_resilience12:{}\t".format(resilience12 * tm.time_amend(t_ss12 - t_ss12_reverse,absolute_time)))
...
plt.plot(t_case2,np.ones(len(t_case2))*task_value,marker="d")
