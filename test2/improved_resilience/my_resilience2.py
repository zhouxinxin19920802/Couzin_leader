...
a7_d =      integrate.quad(lambda x:(A1 + (k1 - A1) / (1 + np.exp(B1_case1 * (x - x1_long))))  if (A1 + (k1 - A1) / (1 + np.exp(B1_case1 * (x - x1_long))))> task_value else 0,t_ss7_reverse,100)[0]
a7_r =      integrate.quad(lambda x:(A2 + (k2_case7 - A2) / (1 + np.exp(B2_case1 * (x - x2_long)))) if (A2 + (k2_case7 - A2) / (1 + np.exp(B2_case1 * (x - x2_long)))) > task_value else 0 ,100,t_ss7)[0]
...
resilience10_improved = sigma10 * rho10 * (delta1_improved + zeta10) * tm.time_amend(t_ss10 - t_ss10_reverse,absolute_time)
...
resilience11_improved = sigma11 * rho11 * (delta1_improved + zeta11 + 1) * tm.time_amend(t_ss11 - t_ss11_reverse,absolute_time)
...
resilience12_improved = sigma12 * rho12 * (delta1_improved + zeta12) * tm.time_amend(t_ss12 - t_ss12_reverse,absolute_time)
