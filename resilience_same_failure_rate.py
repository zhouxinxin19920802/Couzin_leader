...
plt.plot(data_resilience_sg20, color="red", ls="--", lw=1, label="swarm size =20", marker="*")
plt.plot(data_resilience_sg50, color="blue", ls="--", lw=1, label="swarm size =50", marker="o")
plt.plot(data_resilience_sg100, color="gold", ls="--", lw=1, label="swarm size =100", marker=".")
plt.plot(data_resilience_sg200, color="green", ls="--", lw=1, label="swarm size =200", marker="x")
